...
//					.antMatchers("/**").fullyAuthenticated() // needs to be the last matcher, otherwise all matchers following it would never be reached
...
//					.addFilterBefore(awsCognitoJwtAuthenticationFilter, UsernamePasswordAuthenticationFilter.class);
		...
		.permitAll()
		 ...
		 .permitAll()
				// needs to be the last matcher, otherwise all matchers following it would never
				// be reached
